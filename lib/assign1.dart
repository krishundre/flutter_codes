// Create a basic screen in flutter which will display
// a welcome message and will have 2 buttons for the light and
// dark mode.Clicking on those 2 buttons will change the theme
